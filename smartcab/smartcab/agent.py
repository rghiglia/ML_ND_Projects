...
#    global strategy
    ...
    # Now simulate it
    nS = 1 # keep this at 1 until I change the order of the loops below
#    sgys = ['stubborn', 'random', 'guided', 'qlearner']
#    sgys = ['stubborn', 'random', 'guided', 'qlearner']
#    sgys = ['stubborn', 'guided']
    ...
    # Outer should be iter, ineer should be strat, because within each you want to start and end at same point but you want that point to change from iter to iter
