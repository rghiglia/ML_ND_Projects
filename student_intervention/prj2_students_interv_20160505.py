...
# Train a model
# -----------------------------------------------------------------------------
from rg_toolbox_ml import train_clf, predict_clf
...
out_prd_NB_ = predict_clf(clf_NB_, X_CV_trn, y_CV_trn)
print "Prediction F1 = %1.4f" % out_prd_NB_['score']

# Decision Tree
from sklearn.tree import DecisionTreeClassifier
clf_DT_ = DecisionTreeClassifier(max_depth=3)
out_trn_DT_ = train_clf(clf_DT_, X_CV_trn, y_CV_trn);
out_prd_DT_ = predict_clf(clf_DT_, X_CV_trn, y_CV_trn)
print "Prediction F1 = %1.4f" % out_prd_DT_['score']

# kNN
from sklearn.neighbors import KNeighborsClassifier
clf_kNN = KNeighborsClassifier(n_neighbors=3, algorithm='ball_tree')
out_trn_kNN = train_clf(clf_kNN, X_CV_trn, y_CV_trn);
out_prd_kNN = predict_clf(clf_kNN, X_CV_trn, y_CV_trn)
print "Prediction F1 = %1.4f" % out_prd_kNN['score']

# SVM
from sklearn import svm
clf_SVM = svm.SVC(C=1.0)
out_trn_SVM = train_clf(clf_SVM, X_CV_trn, y_CV_trn);
out_prd_SVM = predict_clf(clf_SVM, X_CV_trn, y_CV_trn)
print "Prediction F1 = %1.4f" % out_prd_SVM['score']
...
out_prd_RF_ = predict_clf(clf_RF_, X_CV_trn, y_CV_trn)
...
out_prd_GB_ = predict_clf(clf_GB_, X_CV_trn, y_CV_trn)
